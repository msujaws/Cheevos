exports.main = function(options) {
  ...
  function onDOMContentLoaded(tab) {
    ...
    let facebook_pattern = new MatchPattern("*.facebook.com");
    let googleplus_pattern = new MatchPattern("*.plus.google.com");
    let twitter_pattern = new MatchPattern("*.twitter.com");
    if (ss.google) {
    ...
    //Disabled until the cheevo implementation is complete.
    //if (ss.socialSites >= 3)
