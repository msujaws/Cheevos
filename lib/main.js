...
exports.main = function() {
  ...
  let strings = {
    cheevos: {
      ...
      knowUrRights: {
        id: "about:rights",
        obs: "about:rights",
        message: "The truth won't be told by the few who know. ",
      ...
      frequentFlyer: {
        id: "frequentFlyer",
        obs: "frequentFlyer",
        message: "Nice job, lotsa domains in a three minute timespan.",
        name: "Frequent flyer",
        subAwards: true,
      ...
      yoDawg: {
        ...
        message: "I herd you like browsers",
        name: "Yo Dawg",
        aboutScheme: true,
  ...
  var myExt_bookmarkListener = {
    ...
    onItemAdded: function(aItemId, aFolder, aIndex) { onBookmarkAdded(); },
