  ...
  let strings = {
    cheevos: {
      ...
      privateBrowsingEnter: {
        ...
        description: _("privateBrowsingEnter.description"),
      ...
      homepageChanged: {
        ...
        description: _("homepageChanged.description"),
      ...
      addOnsOpened: {
        id: "Tools:Addons",
        obs: "Tools:Addons",
        description: _("addOnsOpened.description"),
      ...
      knowUrRights: {
        id: "about:rights",
        obs: "about:rights",
        description: _("knowUrRights.description"),
      ...
      revolutionTelevised: {
        ...
        learnMoreLabel: _(".learnMoreLabel"),
      ...
      yoDawg: {
        ...
        description: _("yoDawg.description"),
        hint: _("yoDawg.hint"),
      ...
      feedbackSubmitted: {
        ...
        description: _("feedbackSubmitted.description"),
      ...
      releaseChannels: {
        id: "releaseChannels",
        obs: "releaseChannels",
        description: _("releaseChannels.description"),
        learnMoreUrl: "http://www.mozilla.org/projects/firefox/prerelease.html",
        learnMoreLabel: _("releaseChannels.learnMoreLabel"),
      ...
      devTools: {
        id: "devTools",
        obs: "devTools",
        description: _("devTools.description"),
      ...
      socialButterfly: {
        id: "socialButterfly",
        obs: "socialButterfly",
        description: _("socialButterfly.description"),
