...
exports.main = function(options) {
  ...
  let strings = {
    cheevos: {
      ...
      releaseChannels: {
        id: "releaseChannels",
        obs: "releaseChannels",
        description: "Bookmarks keep track of websites that you would like to come back to.", /* todo need to update these */
        learnMoreUrl: "http://support.mozilla.com/kb/how-do-i-use-bookmarks", /* todo need to update these */
        learnMoreLabel: "Learn more",
        hint: "When you wish upon a star...", /* todo need to update these */
  ...
  function onCheevosPageOpened(tab, cheevo) {
    ...
    if (!cheevo) {
      cheevo = {};
      cheevo.name = "I've got " + toolbarbuttonLabel(acquiredPoints) + " with Cheevos for Firefox. Can you beat me?";
      cheevo.description = "You've got " + toolbarbuttonLabel(acquiredPoints) + ". Use Firefox, gain achievements.";
      title = "";
    }
    tab.attach({
