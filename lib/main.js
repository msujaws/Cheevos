  ...
  let strings = {
    cheevos: {
      ...
      dmRemoveDownloads: {
        ...
        obs: "download-manager-remove-download",
        description: "Clearing all of your downloads can give that fresh breath of air to your browsing.",
        hint: "",
      ...
      pmLoginAdded: {
        ...
        description: "The Firefox Password Manager securely stores the usernames and passwords you use to access websites and then automatically fills them in for you the next time you visit.",
        hint: "An improvement over hidden Post-it notes.",
        name: "Keyboard over the Post-it note",
        award: "bronze"
      },
      homepageChanged: {
        id: "homepageChanged",
      ...
      frequentFlyer: {
        id: "frequentFlyer",
        obs: "frequentFlyer",
        description: "Firefox allows you to keep many tabs open at the same time, allowing for super-advanced high speed browsing.",
      ...
      revolutionTelevised: {
        ...
        hint: "Your own Firefox TV channel.",
