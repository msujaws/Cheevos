exports.main = function(options) {
  ...
  let toolbarbutton = tbb.ToolbarButton({
    ...
    label: _("cheevos.points", acquiredPoints.toString()),
    title: "Cheevos",
  ...
  function onCheevosPageOpened(tab) {
    ...
    let tweetText = _("tweetText", acquiredPoints);
    ...
    tab.attach({
      ...
      contentScript: "populateTemplate('" + escape(tweetText) + "'," +
                                       "'" + escape(stats) + "'," +
                                       "'" + escape(getCheevoListBlockText()) + "',"
                                       "'" + escape(styleCss) + "'," +
                                       "'" + escape(_("cheevosFullName", "Cheevos", "Firefox")) + "'," +
                                       "'" + escape(_("cheevosTagLine", "Firefox")) + "');",
    });
  }
