...
exports.main = function() {
  ...
  function getCheevoListBlockText() {
    ...
    for (let i in totalCheevos) {
      ...
      if (cheevo.subAwards)
        h += ss[cheevo.goldId] ? "<li class='cheevo-block awards-achieved'>" : "<li class='cheevo-block awards-unachieved'>";
      else
        h += ss[cheevo.id] ? "<li class='cheevo-block achieved'>" : "<li class='cheevo-block unachieved'>";
      ...
      if (cheevo.subAwards) {
        ...
        if (ss[cheevo.bronzeId])
          ...
          h += "<li class='bronze-unachieved'></li>";
        if (ss[cheevo.silverId])
          h += "<li class='silver-achieved'></li>";
        else
          h += "<li class='silver-unachieved'></li>";
        if (ss[cheevo.goldId])
          h += "<li class='gold-achieved'></li>";
        else
          h += "<li class='gold-unachieved'></li>";
        h += "</ol></li>";
      } else {
        h += "<div class=awards><span class='" + cheevo.award + "' /></div>";
      }
    }
    return h;
  }
